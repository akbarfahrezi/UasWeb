...
<body>
  ...
  <div class="container">
    <div class="card" id="kartu"onclick="changebackground()">
       <div class="img">
          <img src="img/3-avanza-black-metallic-600x356-1.png">
       </div>
       <div class="top-text">
          <div class="name">
             New Avanza
       ...
       <div class="bottom-text">
          ...
          <div class="btn">
             <a href="index6.php">Pesan</a>
          </div>
       </div>
    </div>
    <div class="card" id="kartu"onclick="changebackground()">
       <div class="img">
          <img src="img/5_super-white-2-min.png">
       </div>
       <div class="top-text">
          <div class="name">
             Innova Reborn
    ...
    <div class="card" id="kartu"onclick="changebackground()">
       <div class="img">
          <img src="img/4-attitude-black_2.png">
       </div>
       <div class="top-text">
          <div class="name">
             Fortuner
